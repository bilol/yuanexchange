...
from src.handlers.query_handlers import handle_exchange_selection
from src.handlers.message_handlers import handle_amount_entry
from src.handlers.user_handlers import user_contact, user_photo, handle_admin_response
...
def start_scheduler():
    ...
    scheduler.add_job(
        ...
        trigger=IntervalTrigger(hours=6),  # Adjust spreads every 6 hours
